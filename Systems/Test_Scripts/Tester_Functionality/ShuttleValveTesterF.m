...
elseif time >= 15 && time < 30
   ...
   dusv_err = double(Errors.JammedCentre);
   lgasv_err = double(Errors.JammedCentre);
   dasv_err = double(Errors.JammedCentre); 
% Test 3: Emergency Supply - Jammed Normal
elseif time >= 30 && time < 45
   lgusv_err = double(Errors.JammedNormal);
   dusv_err = double(Errors.JammedNormal);
   lgasv_err = double(Errors.JammedNormal);
   dasv_err = double(Errors.JammedNormal);
